...
describe('polybius', () =>{
    ...
    it('Capital letters are ignored', () => {
        let actual = polybius('HELLO ALL'); //encoding
        let expected = '3251131343 111313';
        expect(actual).to.equal(expected);
    });

    it('Letters "I" and "J" share a space (as i/j) and the number (42)', () => {
        let actual = polybius('Johnny Jiggles'); //encoding
        let expected = '424332333345 42422222135134';
        expect(actual).to.equal(expected);
    });
